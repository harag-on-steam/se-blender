...
node.mwm_settings.rotation_y = 180.0
...
node.fbx_settings.object_types = {'EMPTY', 'ARMATURE'}
...
# BIN7400 animation
node.fbx_settings.bake_anim = True
node.fbx_settings.bake_anim_use_all_bones = True
node.fbx_settings.bake_anim_force_startend_keying = True
