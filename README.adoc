NOTE: This repository hasn't seen changes in a long time and both Space Engineers and especially Blender have moved on. You are better off searching for alternatives other people have made.
